...
export default function MultiplierRaiseRequest() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("multiplierName", user?.name || "Multiplier Manager");
      formData.append("multiplierEmail", user?.email || "");
      formData.append("targetUserName", selectedUser.Name || selectedUser.user || "Branch SPOC");
      formData.append("targetUserEmail", targetUserEmail);
      ...
      const res = await fetch(`${API_BASE_URL}/multiplier/tickets`, {
        method: "POST",
        body: formData
      });
  ...
  return (
    <DashboardLayout title="Raise Optimization Request" subtitle="Issue guidelines or tasks directly to a Branch SPOC in your managed cluster">
